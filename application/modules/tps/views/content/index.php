...
$num_columns	= 10;
$can_delete	= $this->auth->has_permission('Tps.Content.Delete');
$can_edit		= $this->auth->has_permission('Tps.Content.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/content/tps/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->nama); ?></td>
				<?php else : ?>
