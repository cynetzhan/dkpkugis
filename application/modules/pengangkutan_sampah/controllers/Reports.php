...
{
    protected $permissionCreate = 'Pengangkutan_sampah.Reports.Create';
    protected $permissionDelete = 'Pengangkutan_sampah.Reports.Delete';
    protected $permissionEdit   = 'Pengangkutan_sampah.Reports.Edit';
    protected $permissionView   = 'Pengangkutan_sampah.Reports.View';
    ...
    public function index($offset = 0)
    {
        ...
        $pagerUriSegment = 5;
        $pagerBaseUrl = site_url(SITE_AREA . '/reports/pengangkutan_sampah/index') . '/';
    ...
    public function create()
    {
        ...
        if (isset($_POST['save'])) {
            if ($insert_id = $this->save_pengangkutan_sampah()) {
                ...
                redirect(SITE_AREA . '/reports/pengangkutan_sampah');
            }
