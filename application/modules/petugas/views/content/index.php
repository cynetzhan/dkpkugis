...
$num_columns	= 5;
$can_delete	= $this->auth->has_permission('Petugas.Content.Delete');
$can_edit		= $this->auth->has_permission('Petugas.Content.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/content/petugas/edit/' . $record->id_petugas, '<span class="icon-pencil"></span> ' .  $record->nama_petugas); ?></td>
				<?php else : ?>
