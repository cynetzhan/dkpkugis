...
$num_columns	= 8;
$can_delete	= $this->auth->has_permission('Laporan_Masyarakat.Reports.Delete');
$can_edit		= $this->auth->has_permission('Laporan_Masyarakat.Reports.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/reports/laporan_masyarakat/edit/' . $record->id_laporanmas, '<span class="icon-pencil"></span> ' .  $record->nama_pe_laporanmas); ?></td>
				<?php else : ?>
