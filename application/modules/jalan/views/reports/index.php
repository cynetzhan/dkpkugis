...
$num_columns	= 3;
$can_delete	= $this->auth->has_permission('Jalan.Reports.Delete');
$can_edit		= $this->auth->has_permission('Jalan.Reports.Edit');
	...
	<?php echo form_open($this->uri->uri_string()); ?>
		<table class='table table-striped'>
			...
			<tbody>
				...
				<?php if ($can_edit) : ?>
					<td><?php echo anchor(SITE_AREA . '/reports/jalan/edit/' . $record->id, '<span class="icon-pencil"></span> ' .  $record->nama); ?></td>
				<?php else : ?>
